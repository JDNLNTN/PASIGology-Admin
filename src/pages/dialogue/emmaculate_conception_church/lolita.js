...
export default function IntroductionDialogue() {
 ...
 const { role: currentUserRole } = useAuth();
  ...
  const speakers = ['l', 'p']; // l = Lolita Isa Character, p = Player Character
    ...
    <>
      <Container maxWidth="lg">
        ...
        <Paper sx={{ p: 2, mb: 2 }}>
          ...
          <Typography variant="body1">Note: l = Lolita Isa Character, p = Player Character</Typography>
                      ...
                      <TableCell>
                        {editingId === dialogue.id ? (
                          ...
                          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
                            {/* Actions Row: Approve, Disapprove, Edit for super_admin on pending approval */}
