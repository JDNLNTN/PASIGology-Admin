...
export default function IntroductionDialogue() {
 ...
 const { role: currentUserRole } = useAuth();
  ...
  const speakers = ['r', 'p']; // r = Kuya rene Character, p = Player Character
    ...
    <>
      <Container maxWidth="lg">
        ...
        <Paper sx={{ p: 2, mb: 2 }}>
          ...
          <Typography variant="body1">Note: r = Kuya rene Character, p = Player Character</Typography>
                      ...
                      <TableCell>
                        {editingId === dialogue.id ? (
                          ...
                          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
                            {/* Actions Row: Delete, Approve, Disapprove, Edit (super_admin only) */}
                            <Box sx={{ display: 'flex', gap: 1 }}>
