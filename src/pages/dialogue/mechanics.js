...
export default function MechanicsDialogue() {
  ...
  const speakers = ['p', 'h']; // p = Player Character, h = Harold Character
    ...
    <DialogueLayout>
      <Container maxWidth="lg">
        ...
        <Paper sx={{ p: 2, mb: 2 }}>
          ...
          <Typography variant="body1">Note: p = Player Character, h = Harold Character</Typography>
