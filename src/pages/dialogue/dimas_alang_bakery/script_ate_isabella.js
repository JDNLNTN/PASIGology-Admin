...
export default function IntroductionDialogue() {
 ...
 const { role: currentUserRole } = useAuth();
  ...
  const speakers = ['n', 'p']; // n = Ate Isa Character, p = Player Character
    ...
    <>
      <Container maxWidth="lg">
        <Typography variant="h4" gutterBottom>
          Ate Isabella Dialogue Management
        </Typography>
        {!currentUserRole && (
        ...
        <Paper sx={{ p: 2, mb: 2 }}>
          ...
          <Typography variant="body1">Note: n = Ate Isa Character, p = Player Character</Typography>
