...
export default function PlazaRizalManage() {
  ...
  return (
    <div className="p-4">
      <Card className="shadow-sm">
        <Card.Body>
          <h2 className="mb-3">Plaza Rizal Quiz</h2>
          {loading && (
          ...
          {!loading && !error && (
            rows.length === 0 ? (
              <Alert variant="info">No entries found in table <b>quiz_plaza_rizal</b>.</Alert>
            ) : (
